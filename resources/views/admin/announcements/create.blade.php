    ...
    <div class="w-full flex flex-row">
        ...
        <div class="w-5/6 bg-gray-900">
            <div class="p-3 w-full flex flex-col justify-center">
                <h2 class="text-2xl font-semibold mb-3 text-center dark:text-gray-300">New Announcement</h2>
                    ...
                    class="w-full flex flex-col">
                        ...
                        <div class="w-full flex gap-5">
                            <div class="w-1/2 h-full flex-col justify-between">
                                ...
                                <!-- Skills required -->
                                <div class="mb-3">
                                    <label for="skills" class="block mb-1 text-sm font-medium dark:text-gray-300">Skills
                                        required</label>
                            ...
                            <div class="w-1/2 h-full">
                                <div class="mb-3 h-full">
                                    ...
                                    <textarea name="description" id="myeditorinstance"
                                        class="form-textarea w-full max-h-5/6 h-5/6 box- rounded-md dark:bg-gray-800 dark:text-gray-300">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="text-red-500">{{ $message }}</span>
                                    @enderror
                                </div>
